...
export const fr: Dictionary = {
  ...
  hero: {
    ...
    secondaryCta: { label: "Pourquoi ça existe", href: "/#why" },
    stats: [
  ...
  application: {
    ...
    intro: {
      ...
      subheading:
        "Confier votre enfant à quelqu'un soulève de vraies questions. Commencez la candidature ci-dessous — elle prend environ 7 minutes, et il s'agit d'une demande de renseignements, pas d'un engagement.",
    },
    steps: [
      {
        kind: "welcome",
        title: "Candidature au Boys to Men Retreat",
        body: "Merci de votre intérêt pour le Boys to Men Retreat à Ericeira, au Portugal. Nous comprenons que confier votre enfant à quelqu'un d'autre s'accompagne de questions et de préoccupations importantes. Ce formulaire est uniquement une candidature et non une inscription directe. Il existe deux tranches d'âge : les garçons de 9 à 13 ans et ceux de 13 à 16 ans. Les dates de la retraite sont flexibles pour les deux tranches d'âge. Si vous préférez parler directement, vous pouvez appeler Maxim J Rettich pour un échange individuel au +34 600 235 207.",
        buttonLabel: "Commencer la candidature",
        meta: "Prend 7 minutes",
      },
      { kind: "question", id: "parentEmail", type: "email", title: "Adresse e-mail du parent ou tuteur", placeholder: "nom@exemple.com", required: true },
      { kind: "question", id: "parentNames", type: "text", title: "Nom(s) du parent ou tuteur", placeholder: "Saisissez votre réponse ici…", required: true },
      { kind: "question", id: "countryTown", type: "text", title: "Pays et ville", placeholder: "Saisissez votre réponse ici…", required: true },
      { kind: "question", id: "occupation", type: "text", title: "Profession", placeholder: "Saisissez votre réponse ici…", required: true },
      { kind: "question", id: "parentPhone", type: "tel", title: "Numéro de téléphone du parent ou tuteur", description: "Une fois la réservation effectuée, vous serez ajouté à un groupe WhatsApp.", placeholder: "+34 600 235 207", required: true },
      { kind: "question", id: "familyStructure", type: "longtext", title: "Quelle est la structure familiale actuelle ?", placeholder: "Saisissez votre réponse ici…", required: true },
      { kind: "question", id: "childName", type: "text", title: "Nom de l'enfant", placeholder: "Saisissez votre réponse ici…", required: true },
      { kind: "question", id: "childAge", type: "number", title: "Âge de l'enfant", placeholder: "Saisissez votre réponse ici…", required: true },
      { kind: "question", id: "childDescription", type: "longtext", title: "Décrivez votre enfant en quelques phrases", placeholder: "Saisissez votre réponse ici…", required: true },
      { kind: "question", id: "allergies", type: "longtext", title: "Allergies", placeholder: "Saisissez votre réponse ici…" },
      { kind: "question", id: "medication", type: "longtext", title: "Médicaments", description: "Le cas échéant, soyez aussi précis que possible. Nous en discuterons également en personne en détail.", placeholder: "Saisissez votre réponse ici…" },
      { kind: "question", id: "emergencyContact", type: "tel", title: "Numéro de contact d'urgence", placeholder: "+34 600 235 207", required: true },
      { kind: "question", id: "photoConsent", type: "choice", title: "Nous autorisez-vous à utiliser des photos de votre enfant sur notre site web et notre page Instagram ?", description: "Nous n'utilisons jamais de photos montrant des enfants dans des moments vulnérables ou émotionnels.", options: ["Oui", "Non"], required: true },
      {
        kind: "legal",
        id: "liabilityWaiver",
        title: "Décharge de responsabilité et acceptation des risques",
        body: "Moi, soussigné parent ou tuteur légal du participant nommé ci-dessus, comprends que la participation au Boys to Men Retreat peut comprendre des activités physiques, émotionnelles, récréatives, de plein air, de groupe, de mentorat, de fitness et de développement personnel qui comportent des risques inhérents, y compris, mais sans s'y limiter, des blessures physiques, du stress émotionnel, des accidents pendant le transport ou les activités, des maladies ou urgences médicales, et des dangers liés au plein air ou à l'environnement. Je reconnais que la participation est volontaire et que mon enfant est physiquement, mentalement et émotionnellement apte à participer aux activités de la retraite. J'assume sciemment et volontairement tous les risques liés à la participation à la retraite, qu'ils soient connus ou inconnus.",
      },
      {
        kind: "legal",
        id: "releaseOfLiability",
        title: "Renonciation à recours",
        body: "Dans toute la mesure permise par la loi, je libère, renonce, décharge et tiens quittes Boys to Men Retreat, y compris ses propriétaires, organisateurs, coachs, mentors, bénévoles, employés, prestataires, sociétés affiliées et représentants, de toute réclamation, responsabilité, demande, dommage, perte, coût ou cause d'action découlant de ou lié à la participation à la retraite, y compris ceux résultant d'une négligence simple. Cette renonciation s'applique aux blessures corporelles, aux dommages matériels, à la détresse émotionnelle, à la maladie, aux accidents, au décès et à tout incident imprévu survenant pendant ou en lien avec la retraite.",
      },
      {
        kind: "legal",
        id: "medicalAuthorization",
        title: "Autorisation médicale",
        body: "J'autorise le personnel et les organisateurs de la retraite à obtenir un traitement médical d'urgence pour mon enfant si cela est jugé nécessaire. Je comprends que tous les efforts raisonnables seront déployés pour me joindre en cas d'urgence. J'accepte l'entière responsabilité financière de tout traitement médical, transport, médicament ou service d'urgence fourni.",
      },
      { kind: "question", id: "dateSigned", type: "date", title: "Date de signature", required: true },
    ] as Step[],
  },
