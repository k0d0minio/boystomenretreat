...
export const es: Dictionary = {
  ...
  application: {
    ...
    intro: {
      ...
      subheading:
        "Confiar tu hijo a alguien plantea preguntas legítimas. Comienza la solicitud abajo — tarda unos 7 minutos y es una consulta, no un compromiso.",
    },
    steps: [
      {
        kind: "welcome",
        title: "Solicitud para el Boys to Men Retreat",
        body: "Gracias por tu interés en el Boys to Men Retreat en Ericeira, Portugal. Entendemos que confiar tu hijo a otra persona conlleva preguntas y preocupaciones importantes. Este formulario es solo una solicitud y no una inscripción directa. Hay dos franjas de edad: chicos de 9 a 13 años y chicos de 13 a 16 años. Las fechas del retiro son flexibles para ambas franjas. Si prefieres hablar directamente, puedes llamar a Maxim J Rettich para una conversación individual al +34 600 235 207.",
        buttonLabel: "Iniciar solicitud",
        meta: "Tarda 7 minutos",
      },
      { kind: "question", id: "parentEmail", type: "email", title: "Correo electrónico del padre/madre o tutor", placeholder: "nombre@ejemplo.com", required: true },
      { kind: "question", id: "parentNames", type: "text", title: "Nombre(s) del padre/madre o tutor", placeholder: "Escribe aquí tu respuesta…", required: true },
      { kind: "question", id: "countryTown", type: "text", title: "País y localidad", placeholder: "Escribe aquí tu respuesta…", required: true },
      { kind: "question", id: "occupation", type: "text", title: "Ocupación", placeholder: "Escribe aquí tu respuesta…", required: true },
      { kind: "question", id: "parentPhone", type: "tel", title: "Número de teléfono del padre/madre o tutor", description: "Una vez hecha la reserva, se te añadirá a un grupo de WhatsApp.", placeholder: "+34 600 235 207", required: true },
      { kind: "question", id: "familyStructure", type: "longtext", title: "¿Cuál es la estructura familiar actual?", placeholder: "Escribe aquí tu respuesta…", required: true },
      { kind: "question", id: "childName", type: "text", title: "Nombre del niño", placeholder: "Escribe aquí tu respuesta…", required: true },
      { kind: "question", id: "childAge", type: "number", title: "Edad del niño", placeholder: "Escribe aquí tu respuesta…", required: true },
      { kind: "question", id: "childDescription", type: "longtext", title: "Describe a tu hijo en unas pocas frases", placeholder: "Escribe aquí tu respuesta…", required: true },
      { kind: "question", id: "allergies", type: "longtext", title: "Alergias", placeholder: "Escribe aquí tu respuesta…" },
      { kind: "question", id: "medication", type: "longtext", title: "Medicación", description: "Si procede, sé lo más específico posible. También lo trataremos en persona en detalle.", placeholder: "Escribe aquí tu respuesta…" },
      { kind: "question", id: "emergencyContact", type: "tel", title: "Número de contacto de emergencia", placeholder: "+34 600 235 207", required: true },
      { kind: "question", id: "photoConsent", type: "choice", title: "¿Nos autorizas a usar fotos de tu hijo en nuestra web y en nuestra página de Instagram?", description: "Nunca usamos fotos que muestren a niños en momentos vulnerables o emotivos.", options: ["Sí", "No"], required: true },
      {
        kind: "legal",
        id: "liabilityWaiver",
        title: "Exención de responsabilidad y asunción de riesgo",
        body: "Yo, abajo firmante, padre/madre o tutor legal del participante indicado anteriormente, comprendo que la participación en el Boys to Men Retreat puede incluir actividades físicas, emocionales, recreativas, al aire libre, en grupo, de mentoría, de fitness y de desarrollo personal que conllevan riesgos inherentes, incluidos, entre otros, lesiones físicas, estrés emocional, accidentes durante el transporte o las actividades, enfermedades o emergencias médicas, y peligros al aire libre o medioambientales. Reconozco que la participación es voluntaria y que mi hijo está física, mental y emocionalmente capacitado para participar en las actividades del retiro. Asumo consciente y voluntariamente todos los riesgos asociados a la participación en el retiro, sean conocidos o desconocidos.",
      },
      {
        kind: "legal",
        id: "releaseOfLiability",
        title: "Renuncia de responsabilidad",
        body: "En la máxima medida permitida por la ley, por la presente libero, renuncio, eximo y mantengo indemne a Boys to Men Retreat, incluidos sus propietarios, organizadores, monitores, mentores, voluntarios, empleados, contratistas, filiales y representantes, de toda reclamación, responsabilidad, demanda, daño, pérdida, coste o causa de acción que surja de o esté relacionada con la participación en el retiro, incluidas las derivadas de negligencia simple. Esta renuncia se aplica a lesiones personales, daños materiales, angustia emocional, enfermedad, accidentes, fallecimiento y cualquier incidente imprevisto ocurrido durante el retiro o en relación con él.",
      },
      {
        kind: "legal",
        id: "medicalAuthorization",
        title: "Autorización médica",
        body: "Autorizo al personal y a los organizadores del retiro a obtener tratamiento médico de emergencia para mi hijo si se considera necesario. Entiendo que se harán todos los esfuerzos razonables para contactar conmigo en caso de emergencia. Acepto la plena responsabilidad financiera por cualquier tratamiento médico, transporte, medicación o servicios de emergencia prestados.",
      },
      { kind: "question", id: "dateSigned", type: "date", title: "Fecha de la firma", required: true },
    ] as Step[],
  },
