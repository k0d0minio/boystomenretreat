...
export const nl: Dictionary = {
  ...
  application: {
    ...
    intro: {
      ...
      subheading:
        "Iemand je kind toevertrouwen roept echte vragen op. Start hieronder de aanmelding — het duurt ongeveer 7 minuten en het is een aanvraag, geen verplichting.",
    },
    steps: [
      {
        kind: "welcome",
        title: "Aanmelding Boys to Men Retreat",
        body: "Bedankt voor je interesse in de Boys to Men Retreat in Ericeira, Portugal. We begrijpen dat het toevertrouwen van je kind aan iemand anders gepaard gaat met belangrijke vragen en zorgen. Dit formulier is alleen een aanvraag en geen directe inschrijving. Er zijn twee leeftijdsgroepen: jongens van 9–13 en jongens van 13–16. De retreatdata zijn voor beide leeftijdsgroepen flexibel. Als je liever direct wilt spreken, kun je Maxim J Rettich bellen voor een persoonlijk gesprek op +34 600 235 207.",
        buttonLabel: "Start aanmelding",
        meta: "Duurt 7 minuten",
      },
      { kind: "question", id: "parentEmail", type: "email", title: "E-mailadres van ouder of voogd", placeholder: "naam@voorbeeld.com", required: true },
      { kind: "question", id: "parentNames", type: "text", title: "Naam/namen van ouder of voogd", placeholder: "Typ hier je antwoord…", required: true },
      { kind: "question", id: "countryTown", type: "text", title: "Land en plaats", placeholder: "Typ hier je antwoord…", required: true },
      { kind: "question", id: "occupation", type: "text", title: "Beroep", placeholder: "Typ hier je antwoord…", required: true },
      { kind: "question", id: "parentPhone", type: "tel", title: "Telefoonnummer van ouder of voogd", description: "Na boeking word je toegevoegd aan een WhatsApp-groep.", placeholder: "+34 600 235 207", required: true },
      { kind: "question", id: "familyStructure", type: "longtext", title: "Wat is de huidige gezinssamenstelling?", placeholder: "Typ hier je antwoord…", required: true },
      { kind: "question", id: "childName", type: "text", title: "Naam van het kind", placeholder: "Typ hier je antwoord…", required: true },
      { kind: "question", id: "childAge", type: "number", title: "Leeftijd van het kind", placeholder: "Typ hier je antwoord…", required: true },
      { kind: "question", id: "childDescription", type: "longtext", title: "Beschrijf je kind in een paar zinnen", placeholder: "Typ hier je antwoord…", required: true },
      { kind: "question", id: "allergies", type: "longtext", title: "Allergieën", placeholder: "Typ hier je antwoord…" },
      { kind: "question", id: "medication", type: "longtext", title: "Medicatie", description: "Indien van toepassing, wees zo specifiek mogelijk. We bespreken dit ook persoonlijk in detail.", placeholder: "Typ hier je antwoord…" },
      { kind: "question", id: "emergencyContact", type: "tel", title: "Noodcontactnummer", placeholder: "+34 600 235 207", required: true },
      { kind: "question", id: "photoConsent", type: "choice", title: "Geef je ons toestemming om foto's van je kind te gebruiken op onze website en Instagram-pagina?", description: "We gebruiken nooit foto's waarop kinderen zich in kwetsbare of emotionele momenten bevinden.", options: ["Ja", "Nee"], required: true },
      {
        kind: "legal",
        id: "liabilityWaiver",
        title: "Aansprakelijkheidsverklaring en aanvaarding van risico",
        body: "Ik, ondergetekende ouder of wettelijke voogd van de hierboven genoemde deelnemer, begrijp dat deelname aan de Boys to Men Retreat fysieke, emotionele, recreatieve, outdoor-, groeps-, mentor-, fitness- en persoonlijke-ontwikkelingsactiviteiten kan omvatten die inherente risico's met zich meebrengen, met inbegrip van maar niet beperkt tot lichamelijk letsel, emotionele stress, ongevallen tijdens vervoer of activiteiten, ziekte of medische noodgevallen, en outdoor- of milieurisico's. Ik erken dat deelname vrijwillig is en dat mijn kind fysiek, mentaal en emotioneel in staat is om aan de retreatactiviteiten deel te nemen. Ik aanvaard bewust en vrijwillig alle risico's die verbonden zijn aan deelname aan de retreat, bekend of onbekend.",
      },
      {
        kind: "legal",
        id: "releaseOfLiability",
        title: "Vrijwaring van aansprakelijkheid",
        body: "Voor zover wettelijk toegestaan, ontsla, vrijwaar, onthef en vrijwaar ik hierbij Boys to Men Retreat, met inbegrip van haar eigenaren, organisatoren, coaches, mentoren, vrijwilligers, werknemers, opdrachtnemers, gelieerde partijen en vertegenwoordigers, van alle aanspraken, aansprakelijkheden, vorderingen, schade, verliezen, kosten of rechtsgronden die voortvloeien uit of verband houden met deelname aan de retreat, met inbegrip van die welke voortvloeien uit gewone nalatigheid. Deze vrijwaring geldt voor persoonlijk letsel, materiële schade, emotioneel leed, ziekte, ongevallen, overlijden en alle onvoorziene incidenten die zich tijdens of in verband met de retreat voordoen.",
      },
      {
        kind: "legal",
        id: "medicalAuthorization",
        title: "Medische toestemming",
        body: "Ik machtig de retreatmedewerkers en organisatoren om indien nodig medische noodbehandeling voor mijn kind te verkrijgen. Ik begrijp dat alle redelijke inspanningen zullen worden gedaan om mij in geval van nood te bereiken. Ik aanvaard de volledige financiële verantwoordelijkheid voor verleende medische behandeling, vervoer, medicatie of nooddiensten.",
      },
      { kind: "question", id: "dateSigned", type: "date", title: "Datum van ondertekening", required: true },
    ] as Step[],
  },
