...
export const en = {
  ...
  application: {
    ...
    intro: {
      ...
      subheading:
        "Have a question or ready to apply? Leave your details and a message below and we'll be in touch.",
    },
    steps: [
      {
        kind: "welcome",
        title: "Boys to Men Retreat",
        body: "Thank you for your interest in the Boys to Men Retreat in Ericeira, Portugal. Leave your details and a message below and we'll get back to you. If you'd prefer to speak directly, you can call Maxim J Rettich for a one-to-one conversation at +34 600 235 207.",
        buttonLabel: "Get Started",
        meta: "Takes a minute",
      },
      { kind: "question", id: "name", type: "text", title: "Your name", placeholder: "Type your answer here…", required: true },
      { kind: "question", id: "email", type: "email", title: "Email address", placeholder: "name@example.com", required: true },
      { kind: "question", id: "phone", type: "tel", title: "Phone number", placeholder: "+34 600 235 207", required: true },
      { kind: "question", id: "message", type: "longtext", title: "Your message", placeholder: "Type your message here…", required: true },
    ] as Step[],
  },
